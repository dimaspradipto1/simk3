...
@section('title', 'Edit Observasi Bahaya')

@section('content')
    <div class="pagetitle">
        <h1>Edit Observasi Bahaya</h1>
        <nav>
            <ol class="breadcrumb">
    ...
    <section class="section">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Form Edit Observasi Bahaya</h5>

                        <form method="POST" action="{{ route('observasi-bahaya.update', $observasiBahaya) }}"
                            class="row g-3">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="date" name="tanggal" id="tanggal"
                                    ...
                                    value="{{ old('tanggal', $observasiBahaya->tanggal->format('Y-m-d')) }}" required
                                    autofocus>
                                @error('tanggal')
                            ...
                            <div class="col-md-8">
                                ...
                                <input type="text" name="lokasi" id="lokasi"
                                    ...
                                    value="{{ old('lokasi', $observasiBahaya->lokasi) }}" required>
                                @error('lokasi')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="deskripsi_bahaya" id="deskripsi_bahaya" rows="3"
                                    class="form-control @error('deskripsi_bahaya') is-invalid @enderror" required>{{ old('deskripsi_bahaya', $observasiBahaya->deskripsi_bahaya) }}</textarea>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="kategori_bahaya" id="kategori_bahaya"
                                    ...
                                    @foreach (\App\Models\ObservasiBahaya::KATEGORI_BAHAYA as $value => $label)
                                        <option value="{{ $value }}"
                                            @selected(old('kategori_bahaya', $observasiBahaya->kategori_bahaya) === $value)>
                                            {{ $label }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="tingkat_resiko" id="tingkat_resiko"
                                    ...
                                    @foreach (\App\Models\ObservasiBahaya::RISK_LEVELS as $value => $label)
                                        <option value="{{ $value }}"
                                            @selected(old('tingkat_resiko', $observasiBahaya->tingkat_resiko) === $value)>
                                            {{ $label }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="pic" id="pic"
                                    ...
                                    value="{{ old('pic', $observasiBahaya->pic) }}" required>
                                @error('pic')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" name="target_selesai" id="target_selesai"
                                    ...
                                    value="{{ old('target_selesai', $observasiBahaya->target_selesai->format('Y-m-d')) }}"
                                    required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" name="tanggal_selesai" id="tanggal_selesai"
                                    ...
                                    value="{{ old('tanggal_selesai', optional($observasiBahaya->tanggal_selesai)->format('Y-m-d')) }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="status" id="status"
                                    ...
                                    @foreach (\App\Models\ObservasiBahaya::STATUSES as $value => $label)
                                        <option value="{{ $value }}"
                                            @selected(old('status', $observasiBahaya->status) === $value)>{{ $label }}</option>
                                    @endforeach
                                </select>
                                @error('status')
                                    <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="tindakan_perbaikan" id="tindakan_perbaikan" rows="3"
                                    class="form-control @error('tindakan_perbaikan') is-invalid @enderror">{{ old('tindakan_perbaikan', $observasiBahaya->tindakan_perbaikan) }}</textarea>
