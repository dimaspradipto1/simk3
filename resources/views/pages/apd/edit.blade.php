    ...
    <section class="section">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Form Edit APD</h5>

                        <form method="POST" action="{{ route('apd.update', $apd) }}" class="row g-3">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="jenis_apd" id="jenis_apd"
                                    ...
                                    value="{{ old('jenis_apd', $apd->jenis_apd) }}" required autofocus>
                                @error('jenis_apd')
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="merek" id="merek"
                                    ...
                                    value="{{ old('merek', $apd->merek) }}" required>
                                @error('merek')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" name="jumlah_tersedia" id="jumlah_tersedia" min="0"
                                    ...
                                    value="{{ old('jumlah_tersedia', $apd->jumlah_tersedia) }}" required>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" name="jumlah_dibutuhkan" id="jumlah_dibutuhkan" min="0"
                                    ...
                                    value="{{ old('jumlah_dibutuhkan', $apd->jumlah_dibutuhkan) }}" required>
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="kondisi" id="kondisi"
                                    ...
                                    @foreach (\App\Models\Apd::KONDISI as $value => $label)
                                        <option value="{{ $value }}" @selected(old('kondisi', $apd->kondisi) === $value)>
                                            {{ $label }}</option>
                                    @endforeach
                                </select>
                                @error('kondisi')
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" name="tanggal_beli" id="tanggal_beli"
                                    ...
                                    value="{{ old('tanggal_beli', $apd->tanggal_beli->format('Y-m-d')) }}" required>
                                @error('tanggal_beli')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" name="masa_pakai" id="masa_pakai" min="1"
                                    ...
                                    value="{{ old('masa_pakai', $apd->masa_pakai) }}" required>
                                @error('masa_pakai')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
