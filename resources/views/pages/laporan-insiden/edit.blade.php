    ...
    <section class="section">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Form Edit Laporan Insiden &mdash; {{ $laporanInsiden->no_laporan }}</h5>

                        <form method="POST" action="{{ route('laporan-insiden.update', $laporanInsiden) }}"
                            class="row g-3">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="jenis_insiden" id="jenis_insiden"
                                    ...
                                    value="{{ old('jenis_insiden', $laporanInsiden->jenis_insiden) }}" required
                                    autofocus>
                                @error('jenis_insiden')
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="date" name="tanggal" id="tanggal"
                                    ...
                                    value="{{ old('tanggal', $laporanInsiden->tanggal->format('Y-m-d')) }}" required>
                                @error('tanggal')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="time" name="waktu" id="waktu"
                                    ...
                                    value="{{ old('waktu', $laporanInsiden->waktu) }}" required>
                                @error('waktu')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="lokasi" id="lokasi"
                                    ...
                                    value="{{ old('lokasi', $laporanInsiden->lokasi) }}" required>
                                @error('lokasi')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="nama_korban" id="nama_korban"
                                    ...
                                    value="{{ old('nama_korban', $laporanInsiden->nama_korban) }}" required>
                                @error('nama_korban')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="jabatan" id="jabatan"
                                    ...
                                    value="{{ old('jabatan', $laporanInsiden->jabatan) }}">
                                @error('jabatan')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="departemen" id="departemen"
                                    ...
                                    value="{{ old('departemen', $laporanInsiden->departemen) }}">
                                @error('departemen')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="hari_hilang" id="hari_hilang"
                                    ...
                                    value="{{ old('hari_hilang', $laporanInsiden->hari_hilang) }}">
                                @error('hari_hilang')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="deskripsi_kejadian" id="deskripsi_kejadian" rows="3"
                                    class="form-control @error('deskripsi_kejadian') is-invalid @enderror">{{ old('deskripsi_kejadian', $laporanInsiden->deskripsi_kejadian) }}</textarea>
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea name="penyebab_langsung" id="penyebab_langsung" rows="3"
                                    class="form-control @error('penyebab_langsung') is-invalid @enderror">{{ old('penyebab_langsung', $laporanInsiden->penyebab_langsung) }}</textarea>
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea name="penyebab_dasar" id="penyebab_dasar" rows="3"
                                    class="form-control @error('penyebab_dasar') is-invalid @enderror">{{ old('penyebab_dasar', $laporanInsiden->penyebab_dasar) }}</textarea>
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea name="tindakan_segera" id="tindakan_segera" rows="3"
                                    class="form-control @error('tindakan_segera') is-invalid @enderror">{{ old('tindakan_segera', $laporanInsiden->tindakan_segera) }}</textarea>
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea name="tindakan_perbaikan" id="tindakan_perbaikan" rows="3"
                                    class="form-control @error('tindakan_perbaikan') is-invalid @enderror">{{ old('tindakan_perbaikan', $laporanInsiden->tindakan_perbaikan) }}</textarea>
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="status" id="status"
                                    ...
                                    @foreach (\App\Models\LaporanInsiden::STATUSES as $value => $label)
                                        <option value="{{ $value }}" @selected(old('status', $laporanInsiden->status) === $value)>
                                            {{ $label }}</option>
                                    @endforeach
                                </select>
                                @error('status')
