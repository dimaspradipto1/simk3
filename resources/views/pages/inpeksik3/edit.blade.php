...
@section('title', 'Edit Inspeksi K3')

@section('content')
    <div class="pagetitle">
        <h1>Edit Inspeksi K3</h1>
        <nav>
            <ol class="breadcrumb">
    ...
    <section class="section">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Form Edit Inspeksi K3</h5>

                        <form method="POST" action="{{ route('inpeksik3.update', $inpeksik3) }}" class="row g-3">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="date" name="tanggal" id="tanggal"
                                    ...
                                    value="{{ old('tanggal', $inpeksik3->tanggal->format('Y-m-d')) }}" required
                                    autofocus>
                                @error('tanggal')
                            ...
                            <div class="col-md-8">
                                ...
                                <input type="text" name="lokasi" id="lokasi"
                                    ...
                                    value="{{ old('lokasi', $inpeksik3->lokasi) }}" required>
                                @error('lokasi')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="jenis_inpeksi" id="jenis_inpeksi"
                                    ...
                                    @foreach (\App\Models\Inpeksik3::JENIS_INPEKSI as $value => $label)
                                        <option value="{{ $value }}"
                                            @selected(old('jenis_inpeksi', $inpeksik3->jenis_inpeksi) === $value)>
                                            {{ $label }}</option>
                                    @endforeach
                                </select>
                                @error('jenis_inpeksi')
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="inspektor" id="inspektor"
                                    ...
                                    value="{{ old('inspektor', $inpeksik3->inspektor) }}" required>
                                @error('inspektor')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" name="skor" id="skor" min="0" max="100"
                                    ...
                                    value="{{ old('skor', $inpeksik3->skor) }}" required>
                                @error('skor')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="status_selesai" id="status_selesai"
                                    ...
                                    @foreach (\App\Models\Inpeksik3::STATUS_SELESAI as $value => $label)
                                        <option value="{{ $value }}"
                                            @selected(old('status_selesai', $inpeksik3->status_selesai) === $value)>
                                            {{ $label }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="temuan" id="temuan" rows="3"
                                    class="form-control @error('temuan') is-invalid @enderror">{{ old('temuan', $inpeksik3->temuan) }}</textarea>
                                @error('temuan')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="rekomendasi" id="rekomendasi" rows="3"
                                    class="form-control @error('rekomendasi') is-invalid @enderror">{{ old('rekomendasi', $inpeksik3->rekomendasi) }}</textarea>
                                @error('rekomendasi')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="tindak_lanjut" id="tindak_lanjut" rows="3"
                                    class="form-control @error('tindak_lanjut') is-invalid @enderror">{{ old('tindak_lanjut', $inpeksik3->tindak_lanjut) }}</textarea>
                                @error('tindak_lanjut')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
