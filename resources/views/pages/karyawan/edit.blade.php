            ...
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('karyawan.update', $karyawan) }}" class="row g-3">
                            @csrf
                            @method('PUT')
                                ...
                                <select name="departemen_id" id="departemen_id"
                                    ...
                                    @foreach ($departemens as $departemen)
                                        <option value="{{ $departemen->id }}"
                                            @selected(old('departemen_id', $karyawan->departemen_id) == $departemen->id)>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" name="tanggal_masuk" id="tanggal_masuk"
                                    ...
                                    value="{{ old('tanggal_masuk', optional($karyawan->tanggal_masuk)->format('Y-m-d')) }}">
                                @error('tanggal_masuk')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="is_active" value="1"
                                        id="is_active" @checked(old('is_active', $karyawan->is_active))>
