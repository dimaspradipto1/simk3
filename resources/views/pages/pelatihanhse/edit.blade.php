...
@section('title', 'Edit Pelatihan HSE')

@section('content')
    <div class="pagetitle">
        <h1>Edit Pelatihan HSE</h1>
        <nav>
            <ol class="breadcrumb">
    ...
    <section class="section">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Form Edit Pelatihan HSE</h5>

                        <form method="POST" action="{{ route('pelatihanhse.update', $pelatihanhse) }}" class="row g-3">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="col-md-8">
                                ...
                                <input type="text" name="nama_pelatihan" id="nama_pelatihan"
                                    ...
                                    value="{{ old('nama_pelatihan', $pelatihanhse->nama_pelatihan) }}" required
                                    autofocus>
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="kategori" id="kategori"
                                    ...
                                    @foreach (\App\Models\Pelatihanhse::KATEGORI as $value => $label)
                                        <option value="{{ $value }}"
                                            @selected(old('kategori', $pelatihanhse->kategori) === $value)>{{ $label }}</option>
                                    @endforeach
                                </select>
                                @error('kategori')
                                    <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="date" name="tanggal" id="tanggal"
                                    ...
                                    value="{{ old('tanggal', $pelatihanhse->tanggal->format('Y-m-d')) }}" required>
                                @error('tanggal')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="durasi" id="durasi" placeholder="Contoh: 2 hari"
                                    ...
                                    value="{{ old('durasi', $pelatihanhse->durasi) }}" required>
                                @error('durasi')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" name="jumlah_peserta" id="jumlah_peserta" min="0"
                                    ...
                                    value="{{ old('jumlah_peserta', $pelatihanhse->jumlah_peserta) }}" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="instruktur" id="instruktur"
                                    ...
                                    value="{{ old('instruktur', $pelatihanhse->instruktur) }}" required>
                                @error('instruktur')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="kelas" id="kelas"
                                    ...
                                    @foreach (\App\Models\Pelatihanhse::METODE as $value => $label)
                                        <option value="{{ $value }}"
                                            @selected(old('kelas', $pelatihanhse->kelas) === $value)>{{ $label }}</option>
                                    @endforeach
                                </select>
                                @error('kelas')
                                    <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" name="nilai_evaluasi" id="nilai_evaluasi" min="0" max="100"
                                    ...
                                    value="{{ old('nilai_evaluasi', $pelatihanhse->nilai_evaluasi) }}" required>
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="sertifikat" id="sertifikat"
                                    ...
                                    @foreach (\App\Models\Pelatihanhse::SERTIFIKASI as $value => $label)
                                        <option value="{{ $value }}"
                                            @selected(old('sertifikat', $pelatihanhse->sertifikat) === $value)>
                                            {{ $label }}</option>
                                    @endforeach
                                </select>
                                @error('sertifikat')
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="status" id="status"
                                    ...
                                    @foreach (\App\Models\Pelatihanhse::STATUS as $value => $label)
                                        <option value="{{ $value }}"
                                            @selected(old('status', $pelatihanhse->status) === $value)>{{ $label }}</option>
                                    @endforeach
                                </select>
                                @error('status')
                                    <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" name="link_sertifikat" id="link_sertifikat"
                                    ...
                                    value="{{ old('link_sertifikat', $pelatihanhse->link_sertifikat) }}">
